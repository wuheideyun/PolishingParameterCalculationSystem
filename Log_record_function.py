...
# 参数变更日志记录函数封装----双头摆计算系统----
def log_single_cal_parm_change(button_name,grind_size,belt_speed,accelerate,radius,cerimatic_width,beam_speed_up,overlap,beam_between,num_set,group_count,
                           beam_swing_speed,beam_constant_time,stay_time,num,swing,delay_time,between):
    # 获取每日文件夹路径
    folder_path = create_daily_log_folder()
    # 创建日志文件的路径
    param_change_log_path = os.path.join(folder_path, 'param_change.log')
